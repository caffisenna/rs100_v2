    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <section class="content">
                <h3>駐車許可証ダウンロード</h3>
                <a href="{{ url('/car_registration_pdf?uuid=') }}{{ $uuid }}"
                    class="uk-button uk-button-large uk-button-primary">駐車許可証をダウンロード</a>
                <p class="uk-text uk-text-default">上のボタンより駐車許可証をダウンロードしてください。<br>
                    当日は印刷してダッシュボードに置いて外から見えるようにしてください。</p>
                <p class="uk-text uk-text-default">登録メールアドレス宛に駐車許可証のダウンロードリンクを送付しました。再発行の際はメールに記載のリンクから行ってください。</p>
            </section>
        </div>
