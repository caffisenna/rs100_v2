<div class="card col-sm-6">
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            {!! Form::text('birth_day', isset($entryForm->birth_day) ? $entryForm->birth_day->format('Y/m/d') : null, ['class' => 'form-control', 'id' => 'birth_day','maxlength'=>'10']) !!}
            <p class="text-xs">2001/02/24(YYYY/mm/dd)の形式</p>
            @error('birth_day')
                <div class="error text-danger">{{ $message }}</div>
            @enderror
        </div>
